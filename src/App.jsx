...
const App = () => {
  ...
  const applyLook = useCallback((preset) => {
    ...
    if (typeof window !== "undefined" && window.history?.pushState) {
      ...
      // Prefer the dedicated 1200×630 OG card at /og/{presetId}.png — every
      // preset now has a hand-designed Satori-generated card with the
      // preset name, accent color, blurb, and the worlddots wordmark. Falls
      // back to the chip preview, then the homepage card. Generated by
      // scripts/generate-og-images.js.
      const previewImage = `https://worlddots.app/og/${preset.id}.png`;
  ...
  const handleReset = useCallback(() => {
    ...
    if (typeof window !== "undefined" && window.location.pathname !== "/") {
      ...
      const homeImage = "https://worlddots.app/og/default.png";
