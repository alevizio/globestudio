...
Pick the channel that matches what you're trying to do.
...
→ See [CONTRIBUTING.md](CONTRIBUTING.md). Code is welcome but not required —
presets, examples, screenshots, and docs are all first-class.

## I have a question that doesn't fit any of the above

→ Email `viziomas@gmail.com`. Response time isn't guaranteed for general
questions — the public channels are faster.
